...
local function addBtn(txt, color, parent)
    ...
    s.Color = color
    s.Thickness = 2
    btn.MouseEnter:Connect(function() btn:TweenSize(UDim2.new(0.98,0,0,42),"Out","Quad",0.2,true) end)
    btn.MouseLeave:Connect(function() btn:TweenSize(UDim2.new(0.95,0,0,40),"Out","Quad",0.2,true) end)
    return btn
end
